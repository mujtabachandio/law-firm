    ...
    <>
      ...
      >
        <AboutUsSection
          ...
          sectionTitle='Get Ready for Justice with <span className="text-accent">Karachi Law Firms</span> Your Path to Legal Solutions.'
      ...
      <Section>
        <OfferSection
          ...
          sectionSubTitle="Supercharge Your Legal Defense with Karachi Law Firms! Instant access to premium legal services at transparent, competitive rates."
