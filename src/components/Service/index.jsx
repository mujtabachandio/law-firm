...
export default function Service({ iconUrl, title, subTitle, imgUrl, href }) {
  ...
  return (
    <motion.div 
      className="cs_service cs_style_1 cs_pt_30 cs_pl_30 cs_pr_30 cs_pb_30 bg-white cs_transition_4 shadow-lg cs_mb_25 position-relative overflow-hidden"
    ...
    >
      ...
      <div className="position-relative" style={{ zIndex: 2 }}>
        <div className="cs_service_iconbox d-flex align-items-center cs_mb_25">
          <motion.div 
            className="cs_service_icon d-flex align-items-center justify-content-center cs_rounded_10 cs_mr_20 cs_transition_4 flex-none"
            style={{
              width: '60px',
              height: '60px',
              background: isHovered 
                ? 'linear-gradient(135deg, #1B365D 0%, #E6CFB8 100%)'
        ...
        <motion.div 
          className="cs_service_thumb position-relative cs_rounded_10 overflow-hidden"
          style={{
            height: '200px',
          }}
